...
data <-read.csv("Encycle_2020.csv", check.names=FALSE)
data

### Use ggplot to create plot
plot1 <- ggplot(data, aes(x=KEEPWARM, y=ARREARS, fill=REGION))+
  geom_point(alpha = 0.7, size=2) +
  geom_label_repel(label = data$COUNTRY, size=4,
...
tiff("Graph_ArrearsWarmth_Large.tiff", width = 3500, height = 3000, res=300)
plot(plot1)
dev.off()
